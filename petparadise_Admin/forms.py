...
from petparadise_Admin.models import customer, order, shelter_home, doctor, category, sub_category, product, order_item, \
    gallery, feedback, appointment, area, cart, doctor_slots
...
class doctorslotsForm(forms.ModelForm):
    class Meta:
        model = doctor_slots
        fields=["doctor_time","doctor_id","s_status"]
